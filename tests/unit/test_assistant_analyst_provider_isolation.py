...
from samchat.assistant.analyst_workbench import AnalystEvidence, run_analyst_workbench
...
@pytest.mark.asyncio
async def test_deterministic_operational_request_bypasses_analyst_and_provider():
