...
| RQF-057G - Authorization strategy matrix | PARTIAL_LOCAL_PENDING_COMMIT | this commit | Foundation resolver created from customer matrix and Francisco role mapping; future board registered in Control de accesos as configuracion.estrategias_autorizacion; profile board implemented and send-time advisory evidence is persisted to customer_success_audit_events metadata; enforcement still pending. Evidence: docs/sprints/rqf-057g-authorization-strategy-matrix.md, docs/sprints/rqf-057g2-authorization-profile-board.md, docs/sprints/rqf-057g3-authorization-evidence.md. |
