...
| RQF-057G - Authorization strategy matrix | PARTIAL_LOCAL_PENDING_COMMIT | this commit | Foundation resolver created from customer matrix and Francisco role mapping; board registered in Control de accesos as configuracion.estrategias_autorizacion; profile board implemented; send-time advisory evidence is persisted and now visible in document detail. Enforcement still pending. Evidence: docs/sprints/rqf-057g-authorization-strategy-matrix.md, docs/sprints/rqf-057g2-authorization-profile-board.md, docs/sprints/rqf-057g3-authorization-evidence.md, docs/sprints/rqf-057g4-authorization-evidence-detail.md. |
