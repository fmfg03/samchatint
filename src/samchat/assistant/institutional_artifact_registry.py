...
ARTIFACTS: tuple[InstitutionalArtifactSpec, ...] = (
    ...
    InstitutionalArtifactSpec(
        ...
        output_contract=("contract", "draft", "readiness", "clone_metadata", "activation_diff", "validation_issues"),
        answers=(
        ...
        next_wiring_step="Use SOUL drafts as context substrate for Owner Entity Folder Workspace; keep activation writes behind explicit review/approval.",
    ),
    InstitutionalArtifactSpec(
