...
ARTIFACTS: tuple[InstitutionalArtifactSpec, ...] = (
    ...
    InstitutionalArtifactSpec(
        ...
        domain="tournament",
        name="SOUL Wizard Draft Contract",
        purpose="Read-only contract for building a step-by-step tournament SOUL draft with phases, dates and activities before any operational write.",
        ...
        input_contract=("tournament_name", "edition_year", "categories", "branches", "phases", "activities"),
        output_contract=("contract", "draft", "readiness", "validation_issues"),
        answers=(
        ...
        next_wiring_step="Build the admin UI stepper after this contract stays green; keep writes behind explicit review/approval.",
    ),
    InstitutionalArtifactSpec(
