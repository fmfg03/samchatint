...
from .adapters import (
    ...
    create_third_party_receipt_workflow_adapter,
...
_ROUTES: Dict[str, Callable[..., Awaitable[AdapterResult]]] = {
    ...
    "expenses.create_personal_receipt_workflow": create_personal_receipt_workflow_adapter,
    "expenses.create_third_party_receipt_workflow": create_third_party_receipt_workflow_adapter,
