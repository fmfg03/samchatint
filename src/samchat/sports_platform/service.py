    ...
    *,
    ...
    return {
        ...
        **build_sponsor_media_v1_snapshot(),
        ...
        "modules": [
            {
                "id": "video_recap_sponsor_proof",
                "label": "Agente de Video Recap & Sponsor Proof",
                "base_concept": "browser-use/video-use",
                "function": "video_editing_and_assembly",
                "outputs": [
                    "highlights",
                    "daily_recaps",
                    "reels",
                    "sponsor_clips",
                    "branding_compilations",
                    "audiovisual_evidence",
                ],
                "human_review_required": True,
                "production_integrated": False,
                "implementation_stage": "commercial_snapshot_v0",
                "claim_boundary": claim_boundary,
            },
            {
                "id": "content_rendering_sponsor_evidence",
                "label": "Content Rendering & Sponsor Evidence Agent",
                "base_concept": "Cloudflare Browser Run",
                "function": "render_capture_export_visual_assets",
                "outputs": [
                    "match_cards",
                    "score_cards",
                    "social_cards",
            ...
            {
                "id": "sponsor_obligation_tracker",
                "label": "Sponsor Obligation Tracker",
                "base_concept": "contract_commitment_tracking",
                "function": "track_sponsor_deliverables_against_contract_commitments",
                "outputs": [
                    "sponsor_deliverable_matrix",
                    "pending_sponsor_obligations",
                    "fulfilled_obligations",
                    "missing_evidence_alerts",
                    "sponsor_delivery_score",
                ],
                "human_review_required": True,
                "production_integrated": False,
                "implementation_stage": "commercial_snapshot_v0",
            ...
            {
                "id": "brand_compliance_logo_evidence",
                "label": "Brand Compliance & Logo Evidence Agent",
                "base_concept": "assistive_brand_evidence_review",
                "function": "pre_review_branding_and_sponsor_evidence",
                "outputs": [
                    "logo_presence_checks",
                    "sponsor_mention_checks",
                    "missing_branding_flags",
                    "incorrect_asset_flags",
                    "evidence_frames",
                    "approval_notes",
                ],
                "human_review_required": True,
            ...
            {
                "id": "content_approval_queue",
                "label": "Content Approval Queue",
                "base_concept": "brand_ops_sponsor_approval_workflow",
                "function": "track_content_review_and_approval_states",
                "outputs": [
                    "draft_assets",
                    "automated_check_results",
                    "ops_review_queue",
                    "sponsor_brand_approval_queue",
                    "approved_packages",
                    "approval_timestamps",
                    "approval_comments",
                ],
            ...
            {
                "id": "matchday_content_command_center",
                "label": "Matchday Content Command Center",
                "base_concept": "matchday_marketing_operations_snapshot",
                "function": "coordinate_daily_content_evidence_and_approval_work",
                "outputs": [
                    "daily_matches",
                    "pending_content_assets",
                    "expected_highlights",
                    "active_sponsors_by_match",
                    "missing_evidence",
                    "blocked_approvals",
                    "press_ceremony_event_items",
                    "pending_daily_recap",
                ],
                "human_review_required": True,
                "production_integrated": False,
            ...
            {
                "id": "sponsor_proof_package_builder",
                "label": "Sponsor Proof Package Builder",
                "base_concept": "sponsor_evidence_package_assembly",
                "function": "assemble_sponsor_evidence_packages_from_verified_assets",
                "outputs": [
                    "sponsor_daily_package",
                    "sponsor_final_package",
                    "evidence_index",
                    "media_gallery",
                    "post_links",
                    "dashboard_export",
