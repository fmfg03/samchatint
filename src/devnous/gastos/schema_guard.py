...
REQUIRED_INDEXES: Sequence[RequiredIndex] = (
    ...
    RequiredIndex("solicitudes_prestamo", "ux_solicitudes_prestamo_referencia"),
    RequiredIndex("solicitudes_prestamo", "ix_solicitudes_prestamo_estado"),
    RequiredIndex("prestamo_abonos", "ix_prestamo_abonos_prestamo_estado"),
    RequiredIndex(
...
SCHEMA_PATCHES: Sequence[Tuple[str, str]] = (
    ...
    (
        "create_solicitudes_prestamo_table",
        """
    ...
    (
        ...
        "CREATE UNIQUE INDEX IF NOT EXISTS ux_solicitudes_prestamo_referencia ON solicitudes_prestamo(numero_referencia)",
    ),
    (
        "ix_solicitudes_prestamo_estado",
        "CREATE INDEX IF NOT EXISTS ix_solicitudes_prestamo_estado ON solicitudes_prestamo(estado, creado_en DESC)",
    ),
    (
        "ix_solicitudes_prestamo_solicitante",
        "CREATE INDEX IF NOT EXISTS ix_solicitudes_prestamo_solicitante ON solicitudes_prestamo(solicitante_empleado_id, creado_en DESC)",
    ),
    (
        "ix_prestamo_abonos_prestamo_estado",
        "CREATE INDEX IF NOT EXISTS ix_prestamo_abonos_prestamo_estado ON prestamo_abonos(prestamo_id, estado, creado_en DESC)",
    ),
    (
        ...
        BEGIN
            ...
            IF current_def IS NOT NULL THEN
                IF position('enviar_control_presupuestal' in current_def) = 0
                   ...
                   OR position('regularizar_aprobacion_reembolso' in current_def) = 0 THEN
